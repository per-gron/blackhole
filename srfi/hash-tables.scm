...
(export make-hash-table hash-table? alist->hash-table 
        ...
        hash-table-walk hash-table-fold hash-table->alist hash-table-copy
        hash-table-merge! 
...
;; EDIT: Alvaro Castro-Castilla: this functions couldn't be exported if defined
;; with define-record-type. Blackhole bug?
;;
